...
def load_layered_checkpoint(model, checkpoint_path, device):
    ...
    # full training checkpoints containing optimizer metadata with numpy
    # scalars. These pilot checkpoints are generated by this repo, so loading
    # the trusted local checkpoint with weights_only=False is intentional.
